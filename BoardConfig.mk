...
DEVICE_PATH := device/Kalley/noah
...
BOARD_RECOVERY_DTBO_OFFSET := 0x01699600
...
# Assert
TARGET_OTA_ASSERT_DEVICE := noah,S17_Pro_mini,Silver_Max_Pro_2,huaqiangbei_17mini
...
# Fbe Crypto-Decryption
TW_INCLUDE_CRYPTO := true
TW_INCLUDE_CRYPTO_FBE := true
TW_INCLUDE_FBE_METADATA_DECRYPT := true
TW_USE_FSCRYPT_POLICY := 2
TW_FORCE_KEYMASTER_VER := true
TW_CUSTOM_KEYMASTER_VER := 4.1
